...
class Attention(nn.Module):
    def __init__(self, args: NoPESSMaxModelArgs):
        super().__init__()
...
class TransformerBlock(nn.Module):
    def __init__(self, layer_id: int, args: NoPESSMaxModelArgs):
        super().__init__()
...
class NoPESSMaxTransformer(nn.Module):
    def __init__(self, params: NoPESSMaxModelArgs):
        super().__init__()
        self.params = params
